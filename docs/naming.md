...
- Confirm control of the `baseui.sh` domain and npm organization.
- Confirm the chosen GitHub organization and package scope.
- Perform trademark review in intended markets.
- Use the full `baseui.sh` name in metadata, documentation, social profiles, and announcements.
- Avoid shortening the project name to `Base UI` in public-facing copy.
